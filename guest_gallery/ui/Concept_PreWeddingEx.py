...
from .Concept_PreWedding import Ui_MainWindow
...
class ConceptPreWeddingWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def show_images(self):
        image_dir = resource_path("guest_ui/guest_gallery/images/PreWedding")

        images = [
            "586049411_122252637098254080_4554438379163738816_n.jpg",
            "2-1-scaled.jpg.webp",
            "omni4365.webp",
            "599582048_122257334870254080_9161388208216809461_n.jpg",
            "4afeefe088d0628b780875031d780c69.jpg",
            "omni4476.webp"
        ]
...
if __name__ == "__main__":
    ...
    window = ConceptPreWeddingWindow()
    window.show()
    sys.exit(app.exec())